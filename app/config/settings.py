...
DEFAULT_FRONTEND_BASE = os.getenv("FRONTEND_BASE_URL", "https://demoimpagos.atisa.es")
DEFAULT_AUTH_REDIRECT = os.getenv("AUTH_REDIRECT_URI", "http://localhost:8520/auth/callback")
