...
from app.config.database import init_historial_db, HistorialBase, init_gestion_db, GestionBase, ensure_clientes_database, ensure_gestion_columns, ensure_gestion_tables
...
# Inicialización de BD local de historial
